...
$$ \underset{\text{Biomasa final}}{ P(\text{Forma de vida}|\text{Historia de vida} = \{ap_1, ap_2 , \dots \}) } = \underset{\text{Biomasa final}}{P(\text{Forma de vida})} P(ap_1|\text{Forma de vida}) P(ap_2|ap_1, \text{Forma de vida})
$$
